...
// Input from PF4(SW1) and PF0(SW2), output to PF3 PF2 PF1 (Yellow LED)
// Pressing SW1 starts SOS (Yellow LED flashes SOS).
...
// (PF3 high, PF2 low, and PF1 high) is green LED: SOS 
//    S: Toggle light 3 times with 1/2 sec gap between ON....1/2sec....OFF
//    O: Toggle light 3 times with 2 sec gap between ON....2sec....OFF
//    S: Toggle light 3 times with 1/2 sec gap between ON....1/2sec....OFF
// Inputs: None
